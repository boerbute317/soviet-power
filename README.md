[README.md](https://github.com/user-attachments/files/17533004/README.md)
...
## 介绍
项目名称 提供了一个多种预训练模型的集合，特别针对中文和多语言的自然语言处理任务。这些模型可以在多种框架中使用，例如 PyTorch。
...
- [bert4keras](https://github.com/bojone/bert4keras)：感谢苏神的贡献，为本项目提供了许多实现思路。
- [bert4pytorch](https://github.com/MuQiuJun-AI/bert4pytorch)：该项目帮助我们构建了用 PyTorch 实现 bert4keras 的基础。
...
- **微信号**: <br>
  ![微信二维码](./docs/pics/wechat.jpg)

- **微信群**: <br>
  ![微信群二维码](./docs/pics/wechat_group.jpg)

- **Star History 图表**: [点击查看 Star History](https://star-history.com/#Tongjilibo/bert4torch&Date)

...
from medical_ner.datas.dateset import MyDataset, MyTravelQueryDataset
...
if __name__ == '__main__':
    ...
    data_root_path = "./datas/travel_query"
    model_save_dir = "./travel_query"
    maxlen = 256
    batch_size = 4
    ...
    collate_fn = MyTravelQueryDataset.build_collect_fn(device)

    # 转换数据集
    # noinspection PyTypeChecker
    train_dataloader = DataLoader(
        MyTravelQueryDataset(
            tokenizer, categories_label2id, maxlen,
            os.path.join(data_root_path, 'Travel-Query.xlsx')
        ),
